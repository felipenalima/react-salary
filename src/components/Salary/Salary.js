...
function calculateSalaryFrom(fullSalary) {
  ...
  return {
    baseINSS: formatter.format(baseINSS),
    discountINSS: formatter.format(discountINSS),
    baseIRPF: formatter.format(baseIRPF),
    discountIRPF: formatter.format(discountIRPF),
    netSalary: formatter.format(netSalary),
    percentINSS,
    percentIRPF,
    percentNetSalary,
  };
